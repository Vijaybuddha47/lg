window.addEventListener('load', function() {
	...
	$(window).keydown(function(evt) {
		switch(evt.keyCode) {
			...
			case 37:	// Left key
						if ($("#userName").hasClass("active")) {
							move_cursor_left_side(document.getElementById('userName'));
							
						} else if ($("#userPwd").hasClass("active")) {
							move_cursor_left_side(document.getElementById('userPwd'));
						}
			...
			case 39:	// Right key
						if ($("#userName").hasClass("active")) {
							move_cursor_right_side(document.getElementById('userName'));

						} else if ($("#userPwd").hasClass("active")) {
							move_cursor_right_side(document.getElementById('userPwd'));
						}
						break;
