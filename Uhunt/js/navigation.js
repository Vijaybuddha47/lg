    ...
    $(window).keydown(function(evt) {
        ...
        switch (evt.keyCode) {
            ...
            case 415: // Play
                console.log('play');
                if (!$('#searchInputText').is(":focus")) $('#searchInputText').focus();
                if ($(".video_container").hasClass("active")) VIDEO_PLAYER.play();

                break;

            case 19: // Pause 102
                console.log('pause');
                if ($(".video_container").hasClass("active")) VIDEO_PLAYER.pause();
            ...
            case 37: // LEFT arrow
                if ($("#searchInputText").is(":focus")) move_cursor_left_side(document.getElementById('searchInputText'));
                else rewind_video();
                break;

            case 39: // RIGHT arrow
                if ($("#searchInputText").is(":focus")) move_cursor_right_side(document.getElementById('searchInputText'));
                else forward_video();
            ...
            case 40: //Down key
                if ($("#videoDescriptionContentBox").is(":focus") && SCROLL_DOWN) {
                    SN.pause();
                    var scroll = -5;
                    scrollUpDown(scroll);
                }
