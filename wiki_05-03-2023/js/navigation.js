window.addEventListener('load', function () {
    ...
    $(window).keydown(function (evt) {
        ...
        switch (evt.keyCode) {
            ...
            case 39: // RIGHT arrow
                if ($("ul.video_next_previous_icon_list li:focus").size() < 1) forward_video();
                // remove_menu_focus();
                break;
            ...
            case 40: //Down key
                ...
                } else if ($(".video_container").hasClass("active") && (SELECTED_MENU_INDEX != 0) && $("#video_container").is(":focus")) {
