...
window.addEventListener("load", function () {
  ...
  SN.add({
    id: "playcontrols",
    selector: '#playcontrols .focusable',
    restrict: "self-first",
    defaultElement: '#Play',
  ...
  SN.remove("customPlay");
  SN.add({
    id: "customPlay",
    selector: '#customPlay .focusable',
    restrict: "self-first",
    defaultElement: '#playBtn',
    enterTo: 'last-focused',
  });
  SN.makeFocusable();
  SN.focus("customPlay");
  ...
  // When menu foucs
  $('#customPlay').on('sn:focused', function (e) {
    console.log("play buttom focused.");
  });

  $('#customPlay').on('sn:enter-down', function (e) {
    console.log("play buttom enter down.");
    $(".play-container").css("display", "none");
    $(".player").css("display", "block");
    SN.focus("playcontrols");
