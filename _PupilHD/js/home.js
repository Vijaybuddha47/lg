...
function reset_video_list(category, index) {
    ...
    for (i = index; i < _.size(APP_VIDEO_CATEGORY); i++) {
        ...
        if (APP_VIDEO_CATEGORY[i]) {
            ...
            str += '<div class="half_video_left_side" id="half_video_left_side_' + APP_VIDEO_CATEGORY[i]["id"] + '" ><div class="thumbmnail_poster"><img src="images/default.png" id="left_half_img_' + APP_VIDEO_CATEGORY[i]["id"] + '" alt="logo"></div><div class="channel" id="left_half_name_' + APP_VIDEO_CATEGORY[i]["id"] + '"></div></div><h1 class="video_list_heading" id="' + APP_VIDEO_CATEGORY[k]["id"] + '">' + APP_VIDEO_CATEGORY[i]["title"] + '</h1>';
