...
function getMacAddress() {
    ...
    webOS.service.request("luna://com.webos.service.connectionmanager", {
        ...
        onSuccess: function (args) {
            console.log(args);
            if (args.wiredInfo.macAddress) GET_MAC_ADDRESS = args.wiredInfo.macAddress;
            else if (args.wifiInfo.macAddress) GET_MAC_ADDRESS = args.wifiInfo.macAddress;
            console.log(GET_MAC_ADDRESS);
        },
