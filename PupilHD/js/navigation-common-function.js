function manage_spatial_navigation(containerClass, favoriteStatus, vodId) {
    switch (containerClass) {
        case "menu_container":
            ...
            $('#left_sidebar').on('sn:unfocused', function (e) {
                console.log("left sidebar focus...");
                if (!$(".menu_container").hasClass("toggle_menu")) $(".menu_container").addClass("toggle_menu");
            });
            ...
            $('#tv_channel').on('sn:enter-down', function (e) {
                console.log("tv channel button focused...");
                if (!$(".home_container").hasClass("active")) {
                    MENU_INDEX = TAB_INDEX = PAGE_INDEX = $("#" + e.target.id).index();
                    $("#home_spinner").show();
            ...
            $('#video_library').on('sn:enter-down', function (e) {
                ...
                if (!$(".video_library_container").hasClass("active")) {
                    ...
                    get_new_release_video();
                }
            });

            $('#search').on('sn:enter-down', function (e) {
            ...
            $('#setting').on('sn:enter-down', function (e) {
            ...
            $('#exit').on('sn:enter-down', function (e) {
...
function set_video_list_focus(index) {
    ...
    var restrictVal = "self-first";
    var total = $('[id^=video_list_]').length;
    for (i = 0; i <= total; i++) {
        var containerId = "video_list_" + i;
        var itemId = "video_item_" + i + "_0";
