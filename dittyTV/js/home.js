...
function set_menu() {
    ...
    if (totalMenu > 0) {
        for (var i = 0; i < totalMenu; i++) {
            ...
            str += '<li class="menu_list_box focusable" tabindex="' + tabindex + '" id="' + focusName + '" ' + leftFocus + rightFocus + upFocus + '>' + APP_DATA_ARRAY[i]['menu_name'] + '</li>';
            counter++;
        }
...
function set_home_screen() {
    ...
    $("ul#catList, ul#subcatList").html("").removeAttr("style");
    $(".home_container").show();
    ...
    if (totalItems > 0) {
        for (i = 0; i < totalItems; i++) {
            ...
            str += '<li class="home_listbox focusable" tabindex="1" id="' + focusName + '" ' + rigthFocus + leftFocus + upFocus + downFocus + '>';
...
function set_about_screen() {
    ...
    if (APP_DATA_ARRAY[SELECTED_MENU_INDEX].menu_page_description) {
        str = '<div class="about_box focusable" tabindex="1" id="aboutBox" data-sn-right="null" data-sn-left="null" data-sn-down="null">';
            ...
            if (TIME_STATMP == timestamp) {
                if (response != undefined && response != "") {
                    ...
                    if (FIRST_PAGE_SELECTED_INDEX == 2) {
                        ...
                        $("ul#catList").addClass("catergory_inner_list").removeClass("catergory_container_list");
                        ...
                        $("ul#catList").addClass("catergory_container_list").removeClass("catergory_inner_list");
                    ...
                    if (totalItems > 1) {
                        ...
                        for (i = 0; i < totalItems; i++) {
                            ...
                            str += '<li class="' + liClass + '" tabindex="2" id="' + focusName + '" ' + rigthFocus + leftFocus + upFocus + downFocus + '>';
...
function set_subcat_list(timestamp) {
    ...
    if (catType == "P") {
        ...
        $("ul#subcatList").html("").removeAttr("style");
        ...
        if (menuType == 'S') {
            ...
            if (catType == "S") url = SUBCAT_DATA_ARRAY[SECOND_PAGE_SELECTED_INDEX]['stream_feed_url'];
        }
                ...
                if (totalItems > 0) {
                    ...
                    for (i = 0; i < totalItems; i++) {
                        if (data['data'][i] != "undefined" && _.size(data['data'][i]) > 0) {
                            ...
                            str += '<li class="detail_list_text focusable" id="video_subcat_' + ITEM_COUNTER + '" tabindex="3" ' + focusName + rigthFocus + leftFocus + upFocus + downFocus + '><div class="sub_title_container" id="sub_title_container_' + i + '"><div class="sub_title ' + titleClass + '" id="' + titleId + '">' + playPauehtml + title + '</div></div></li>';
